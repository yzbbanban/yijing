...
public interface ImageEngine {
     ...
     */
    void loadThumbnail(int resize, Drawable placeholder, ImageView imageView, Uri uri);
     ...
     * @param uri         Uri of the loaded image
     */
    void loadGifThumbnail(int resize, Drawable placeholder, ImageView imageView, Uri uri);
     ...
     * @param uri       Uri of the loaded image
     */
    void loadImage(int resizeX, int resizeY, ImageView imageView, Uri uri);
     ...
     * @param uri       Uri of the loaded image
     */
    void loadGifImage(int resizeX, int resizeY, ImageView imageView, Uri uri);
