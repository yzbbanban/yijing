...
public class OutsideAdapter extends BaseQuickAdapter<OutsideDetail, BaseMyViewHolder> {
    public OutsideAdapter(int layoutResId, @Nullable List<OutsideDetail> data) {
