...
public class YxYjModuleItemAdapter extends BaseQuickAdapter<ModuleItemBean, BaseMyViewHolder> {
    public YxYjModuleItemAdapter(int layoutResId, @Nullable List<ModuleItemBean> data) {
