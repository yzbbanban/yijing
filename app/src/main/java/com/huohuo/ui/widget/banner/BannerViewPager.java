package com.huohuo.ui.widget.banner;
...
public class BannerViewPager extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private int resId_piont_press = R.drawable.shape_banner_point_press;
    private int resId_piont = R.drawable.shape_banner_point;
